function[min_val, max_val, title_str] = plot_pqrst_ten_minute_means(target_subject, dosage, varargin)

number_of_subjects = 2;
[subject_ids, subject_sessions] = get_subject_ids(number_of_subjects);
subj_idx = find(strcmp(target_subject, subject_ids));
load(fullfile(get_project_settings('data'), subject_ids{subj_idx}, subject_sessions{subj_idx}, sprintf('pqrst_ten_minute_means.mat')));
