function[matching_confusion_mat] = matching_driver(target_idx, ecg_test_Y, annt, matching_pm, crf_pred_lbl)

ecg_labels = {'P', 'Q', 'R', 'S', 'T', 'U'};
nLabels = numel(ecg_labels);
matching_confusion_mat = zeros(nLabels, nLabels);
load(fullfile(pwd, 'ecgpuwave', 'annotations', sprintf('P20_040d_wqrs.mat')));
