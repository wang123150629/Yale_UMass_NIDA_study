function[] = plot_wsubj_mean(tr_percent, which_plot)

% plot_wsubj_mean(60, 1)
...
feature_ordering = [1, 9, 10, 7, 8, 6, 4, 2, 3, 5];
...
title(sprintf('Mean within subject (%d subjects), Logistic reg, Area under ROC', nSubjects),...
		'FontSize', tl_fs, 'FontWeight', 'b', 'FontName', 'Times');
file_name = sprintf('%s/mean_%dwsubj_%s_auc', plot_dir, nSubjects, sess_str);
