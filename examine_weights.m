...
feat_2Ticks = 1:5;
feat2_xticks = {'pt', 'rt', 'qt', 'qt_c', 'pr'};
feat_3Ticks = 1:10;
feat3_xticks = {'pt', 'rt', 'qt', 'qt_c', 'pr', 'p', 'q', 'r', 's', 't'};
...
for f = 1:length(set_of_features_to_try)
	...
	load(sprintf('%s/l2_betas/%s_weight_analysis.mat', result_dir, unique_str));
	betas = betas(2:end);
