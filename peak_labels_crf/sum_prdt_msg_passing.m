function[all_unary_marginals, all_pairwise_marginals, log_likelihood] =...
...
for s = 1:nSamples
	if isempty(ecg_Y)
		[all_unary_marginals{s}, all_pairwise_marginals{s}, log_likelihood(1, s)] =...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[unary_marginal, pairwise_marginal, log_likelihood] = single_pairwise_marginals(data_X, data_Y,...
										feature_params, trans_params, nLabels)
