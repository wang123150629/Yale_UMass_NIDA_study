...
for s = 4:number_of_subjects
	switch subject_ids{s}
	case 'P20_040', classes_to_classify = [1, 2; 1, 3; 1, 4; 5, 6; 6, 7; 6, 8; 7, 8];
	case 'P20_048', classes_to_classify = [1, 2; 1, 3; 1, 4; 5, 6; 6, 7; 6, 8; 7, 8];
	case 'P20_058', classes_to_classify = [1, 2; 1, 3; 1, 4; 5, 6; 6, 7; 6, 8; 7, 8];
	case 'P20_060', classes_to_classify = [1, 2; 1, 3; 1, 4; 5, 6; 6, 7; 6, 8; 7, 8; 6, 9; 6, 10; 9, 10];
	end
