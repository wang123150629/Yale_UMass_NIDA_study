function[] = write_to_html(analysis_id, subject_id, lambda, dictionary, first_baseline_subtract,...
		...
		mul_total_errors, crf_total_errors, data_split, dimm)
...
line_str = sprintf('<tr><td>%s</td><td>%s</td><td>%0.4f</td><td>%d</td><td>%s</td><td>%d</td><td>%d</td><td>%d</td><td>%d(%s)</td><td>%d</td><td>%d</td><td>%d</td><td>%0.2f</td><td>%d</td><td>%0.2f</td><td>%d</td></tr>\n</table> </body> </html>',...
